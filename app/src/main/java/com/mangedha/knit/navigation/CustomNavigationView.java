package com.mangedha.knit.navigation;
...
public class CustomNavigationView extends ScrimInsetsFrameLayout {
    ...
    /**
     * Sets the drawer view for the navigation drawer along with the bottom margin
     *
     * @param view         drawer view for the navigation drawer
     * @param marginBottom bottom margin of drawer view
     */
